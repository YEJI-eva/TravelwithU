		...
		<!-- One -->
			<section id="one" class="wrapper post bg-img" data-bg="banner2.jpg">
				<div class="inner">
					<article class="box">
						<header>
							<h2>My First Travel Diary</h2>
							<p>11.01.2019</p>
						</header>
						<div class="content">
							<p>여러분의 다이나믹한 여행을 위해 최선을 다하는 예르시입니다.<br>
							 세상에서 하나뿐인 로드 트립을 떠날 준비가 되셨나요? 여행의 매력에 빠져보세요! <br>
							 단, 사고 발생 시 책임지지 않습니다 O:)</p>
						</div>
						<footer>
							<a href="board" class="button alt">Learn More</a>
						</footer>
					</article>
				</div>
...
=======
		...
		<meta charset="utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=0, user-scalable=no, target-densitydpi=medium-dpi" /><!--모바일페이지크기조절메타태그--> 		<link rel="stylesheet" href="css/main.css"/>
	</head>
	<body>
